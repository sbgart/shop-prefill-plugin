 ...
 * - Генерирует и хранит хеш в HTTP-only куки (1 год, автопродление при каждом визите через frontendHead)
...
class shopPrefillPluginGuestHashStorage
{
     ...
     *
     * Логика:
     * 1. Если куки есть — продлеваем на 1 год и возвращаем
     * 2. Если куки нет — генерируем новый хеш, сохраняем в куки
     *
     * Этот метод вызывается из хука frontendHead при каждом визите на сайт,
     * что обеспечивает автоматическое продление срока жизни cookie.
     *
