...
**Статус:** ✅ Закрыта 11.09.2026 — все шесть пунктов разобраны, план и статус по каждому — [issue-98-minor-findings-fix-plan.md](../../plans/done/issue-98-minor-findings-fix-plan.md)
