...
Три вопроса — три источника. Смешение источников и породило [баг со свёрнутой пустой доставкой](../bugs/zen-collapse-on-upstream-checkout-error.md).
