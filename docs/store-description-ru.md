...
<!-- Готовый HTML-фрагмент карточки со стилями и скриншотами: store-description-preview.html. Файл содержит только описание, без имитации интерфейса магазина. -->
...
![Крупный фрагмент заполненной формы оформления заказа](assets/store/checkout-filled-closeup.png)
...
![Дзен-режим: компактная сводка заказа с возможностью изменить каждый раздел](assets/store/checkout-zen-focus.png)
...
![Личный кабинет авторизованного покупателя с историей заказов](assets/store/account-orders-focus.png)
...
![Диалог «Мои варианты доставки» с сохранёнными адресами](assets/store/delivery-variants-focus.png)
...
В самом начале карточки, сразу после короткого описания, размещается адаптивная HTML-инфографика из трёх простых блоков. Рабочая версия находится в `store-description-preview.html`:
