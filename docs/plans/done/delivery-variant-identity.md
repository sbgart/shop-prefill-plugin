...
**Создан:** 23.08.2026
**Источник:** [issue-84](../../codereview/done/issue-84-prefill-inconsistent-across-groups.md) §1, уточнено в разборе — тип доставки функционально определяется вариантом
...
- [issue-84 §1](../../codereview/done/issue-84-prefill-inconsistent-across-groups.md) — закрыт этим планом
- [issue-60](../../codereview/done/issue-60-cross-section-write-details-custom.md) — снапшот-часть снята архитектурой (снапшота больше нет), кросс-секционная запись `details.custom` из `shipping`-кода частично сужена (гейтится вариантом), но не убрана — issue остаётся открытой
